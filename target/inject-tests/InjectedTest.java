...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","C:\\Users\\jbull\\Downloads\\expose-build-xml-plugin\\expose-build-xml");
    parameters.put("artifactId","expose-build-xml");
    parameters.put("outputDirectory","C:\\Users\\jbull\\Downloads\\expose-build-xml-plugin\\expose-build-xml\\target\\classes");
    parameters.put("testOutputDirectory","C:\\Users\\jbull\\Downloads\\expose-build-xml-plugin\\expose-build-xml\\target\\test-classes");
